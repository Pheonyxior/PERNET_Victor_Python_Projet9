...
- Pour accéder au site web: http://localhost:8000.
- Pour accéder à l'administration de django: http://localhost:8000/admin.
- Pour créer un nouvel administrateur `python .\merchex\manage.py createsuperuser`
